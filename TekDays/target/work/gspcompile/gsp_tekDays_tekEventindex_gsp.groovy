...
printHtmlPart(17)
expressionOut.print(tekEventInstance.nickname)
printHtmlPart(6)
expressionOut.print(fieldValue(bean: tekEventInstance, field: "name"))
printHtmlPart(18)
createTagBody(3, {->
...
invokeTag('link','g',45,['mapping':("tek_days_event"),'params':([nickname: tekEventInstance.nickname])],3)
printHtmlPart(19)
...
printHtmlPart(20)
invokeTag('formatDate','g',53,['date':(tekEventInstance.startDate)],-1)
printHtmlPart(21)
i++
}
}
printHtmlPart(22)
invokeTag('paginate','g',60,['total':(tekEventInstanceCount ?: 0)],-1)
printHtmlPart(23)
})
...
public static final long LAST_MODIFIED = 1419250213842L
