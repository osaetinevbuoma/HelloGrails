...
printHtmlPart(28)
invokeTag('formateBoolean','g',78,['boolean':(taskInstance?.completed),'true':("Yes"),'false':("No")],-1)
printHtmlPart(29)
}
printHtmlPart(30)
createTagBody(2, {->
...
invokeTag('link','g',86,['class':("edit"),'action':("edit"),'resource':(taskInstance)],3)
printHtmlPart(32)
...
invokeTag('form','g',89,['url':([resource:taskInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(34)
})
...
public static final long LAST_MODIFIED = 1418651734570L
